# SSOT - conclave-meeting
## Status: Implemented

**Domain:** admin  
**Module:** conclave-meeting  
**Last Updated:** 2026-04-09

## 1) Purpose and boundaries
This file is the single source of truth for the **conclave-meeting** module.

## 2) Implemented surface
### Routes
- /admin/conclave/add
- /admin/conclave/list
- /admin/conclave/edit/[eventId]
- /admin/conclave/addmeeting/[eventId]
