...
This file is the single source of truth for the **monthly-meeting** module.

## 2) Implemented surface
### Routes
- /admin/monthlymeeting
- /admin/monthlymeeting/list
- /admin/monthlymeeting/add
- /admin/monthlymeeting/[eventId]
