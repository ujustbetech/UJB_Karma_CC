# SSOT - contribuitionpoint
## Status: Implemented

**Domain:** user  
**Module:** contribuitionpoint  
**Last Updated:** 2026-04-09

## 1) Purpose and boundaries
This file is the single source of truth for the **contribuitionpoint** module.

## 2) Implemented surface
### Routes
- /user/contribuitionpoint
...
- app/(user)/user/**
- components/mobile/MobileBottomNav.js

## 3) Data and collection contract
- COLLECTIONS and per-module firestore docs

## 4) Business rules and validation behavior
- User portal module contract and guard behavior.
