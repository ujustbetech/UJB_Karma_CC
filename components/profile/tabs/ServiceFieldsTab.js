...
export default function ServiceFieldsTab({ user = {}, setUser, ujbCode }) {
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h3 className="font-semibold text-gray-200 text-lg">Service Fields</h3>
          <button
        ...
        <div className="space-y-5">
          {services.length === 0 ? (
            ...
            services.map((item, i) => <OfferingCard key={i} item={item} />)
          )}
        </div>
      </div>
